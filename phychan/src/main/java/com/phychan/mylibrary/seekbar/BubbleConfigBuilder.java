...
public class BubbleConfigBuilder {
    ...
    public BubbleConfigBuilder isShowBubbleView(boolean isShowBubbleView){
        this.isShowBubbleView = isShowBubbleView;
        return this;
    }
    ...
    public boolean isShowBubbleView() {
        return isShowBubbleView;
    }

    public void setShowBubbleView(boolean showBubbleView) {
        isShowBubbleView = showBubbleView;
    }
}
