package com.phychan.mylibrary.smallvideo;
...
//        }
    ...
    private void finishActivity() {
        if (isFinish) {
            movieRecorderView.stop();
            Log.e("MediaPath", movieRecorderView.getRecordFile().getAbsolutePath());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE && resultCode == RES_CODE) {
            setResult(RES_CODE);
            String mediaPath = movieRecorderView.getRecordFile().getAbsolutePath();
